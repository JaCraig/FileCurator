...
namespace FileCurator.Formats.PowerPoint
{
    ...
    /// PowerPoint format
    /// </summary>
    /// <seealso cref="BaseClasses.FormatBaseClass{PowerPointReader, PowerPointWriter, IGenericFile}"/>
    public class PowerPointFormat : FormatBaseClass<PowerPointReader, PowerPointWriter, IGenericFile>
    {
        /// <summary>
