...
namespace FileCurator.Default.Ftp
{
    ...
    public class FtpFileSystem : FileSystemBase
    {
        ...
        /// Relative starter
        /// </summary>
        protected override string HandleRegexString { get; } = "^ftps?://";
        ...
        {
            return new FtpDirectory(AbsolutePath(path), credentials);
        }
        ...
        {
            return new FtpFile(AbsolutePath(path), credentials);
        }
